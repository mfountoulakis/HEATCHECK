...
var _getLeaderImageUrl = require("./utils/getLeaderImageUrl");
...
// constructors
var player = function player(name, image_url, playerRank) {
    undefined.name = name;
    undefined.image_url = image_url;
    undefined.playerRank = playerRank;
};
