...
_commander2.default.version('0.1.0').option('-p, --points', 'points leaders').option('-b, --blocks', 'blocks leaders').option('-a, --assists', 'assists leaders').option('-s, --steals', 'steals leaders');
