...
var _pushTable = require("./pushTable");

var _pushTable2 = _interopRequireDefault(_pushTable);
                ...
                switch (_context.prev = _context.next) {
                    ...
                    case 3:
                        ...
                        leagueLeaders.resultSet.rowSet.slice(0, 15).forEach(function (element) {
                            ...
                            (0, _getLeaderImageURL2.default)(playerName, playerRank).then(function (l) {
                                (0, _pushTable2.default)();
                            });
                        });
                        _context.next = 10;
                        break;
